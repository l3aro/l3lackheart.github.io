...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ColorMixPageModule", function() { return ColorMixPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(41);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__color_mix__ = __webpack_require__(325);
...
var ColorMixPageModule = /** @class */ (function () {
    function ColorMixPageModule() {
    }
    ColorMixPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__color_mix__["a" /* ColorMixPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__color_mix__["a" /* ColorMixPage */]),
                __WEBPACK_IMPORTED_MODULE_3_ngx_filepond__["a" /* FilePondModule */]
            ],
        })
    ], ColorMixPageModule);
    return ColorMixPageModule;
}());

//# sourceMappingURL=color-mix.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ColorMixPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__providers_global_global__ = __webpack_require__(55);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__providers_rest_rest__ = __webpack_require__(54);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_loading_loading__ = __webpack_require__(206);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_ionic_angular__ = __webpack_require__(41);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_ngx_filepond__ = __webpack_require__(316);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_filepond_plugin_image_preview_dist_filepond_plugin_image_preview_esm__ = __webpack_require__(318);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_filepond_plugin_image_exif_orientation_dist_filepond_plugin_image_exif_orientation_esm__ = __webpack_require__(319);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_filepond_plugin_file_validate_type_dist_filepond_plugin_file_validate_type_esm__ = __webpack_require__(320);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
Object(__WEBPACK_IMPORTED_MODULE_5_ngx_filepond__["b" /* registerPlugin */])(__WEBPACK_IMPORTED_MODULE_6_filepond_plugin_image_preview_dist_filepond_plugin_image_preview_esm__["a" /* default */], __WEBPACK_IMPORTED_MODULE_7_filepond_plugin_image_exif_orientation_dist_filepond_plugin_image_exif_orientation_esm__["a" /* default */], __WEBPACK_IMPORTED_MODULE_8_filepond_plugin_file_validate_type_dist_filepond_plugin_file_validate_type_esm__["a" /* default */]);
/**
 * Generated class for the ColorMixPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var ColorMixPage = /** @class */ (function () {
    function ColorMixPage(navCtrl, loading, rest, alert, global) {
    ...
    ColorMixPage.prototype.ionViewWillEnter = function () {
        var _this = this;
        var currentTime = new Date();
        this.timestamp = currentTime.getTime();
        this.loading.show();
        this.rest.initColorMix(this.timestamp).then(function (scs) {
            _this.loading.hide();
        }, function (err) {
            _this.loading.hide();
        ...
        this.myPond.pond.setOptions({
            server: {
                process: {
                    url: this.rest.UPLOAD_COLOR_MIX_URL + '/process?token=' + user_token + '&&timestamp=' + this.timestamp,
                    method: 'POST',
                    withCredentials: false,
                ...
                revert: {
                    url: this.rest.UPLOAD_COLOR_MIX_URL + '/revert?token=' + user_token,
                    method: 'DELETE'
                },
                restore: null,
                load: null,
    ...
    ColorMixPage.prototype.pondHandleInit = function () {
        console.log('FilePond has initialised', this.myPond);
    };
    ColorMixPage.prototype.pondHandleAddFile = function () {
        this.pondFiles = this.myPond.getFiles().length;
    };
    ColorMixPage.prototype.pondHandleRemoveFile = function () {
        this.pondFiles = this.myPond.getFiles().length;
    };
    ColorMixPage.prototype.presentNotifications = function (myEvent) {
        console.log(myEvent);
    ...
    ColorMixPage.prototype.clickUpload = function () {
        var _this = this;
        this.loading.show();
        this.rest.postColorMixId({ name: this.name, content: this.content }, this.timestamp).then(function (scs) {
            var successUpload = _this.alert.create({
                message: 'Yêu cầu đã được gửi lên máy chủ thành công.',
                buttons: [
                    {
                        text: 'OK',
                        handler: function () {
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_3__angular_core__["ViewChild"])('myPond2'),
        __metadata("design:type", Object)
    ], ColorMixPage.prototype, "myPond", void 0);
    ColorMixPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_3__angular_core__["Component"])({
            selector: 'page-color-mix',template:/*ion-inline-start:"D:\Projects\cponpaint\gradutation\cponpaint-app\src\pages\color-mix\color-mix.html"*/'<!--\n\n  Generated template for the ColorMixPage page.\n\n\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n\n  Ionic pages and navigation.\n\n-->\n\n<ion-header>\n\n\n\n  <ion-navbar color="primary">\n\n    <ion-title>Yêu cầu phối màu</ion-title>\n\n    <ion-buttons end>\n\n      <button ion-button tappable (click)="presentNotifications($event)">\n\n        <div class="badge1" [attr.data-badge]="global.unreadNotificationCount">\n\n            <ion-icon [ngClass]="{\'animated infinite swing delay-2s\':global.unreadNotificationCount > 0}" name="notifications"></ion-icon>\n\n        </div>\n\n      </button>\n\n    </ion-buttons>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n\n\n<ion-content padding>\n\n  <button ion-button block [disabled]="pondFiles === 0 || name === \'\'" (click)="clickUpload()" >Gửi yêu cầu</button>\n\n  \n\n  <div input-field>\n\n    <!-- Input-field-text -->\n\n    <ion-item no-padding>\n\n      <ion-label stacked>Tên yêu cầu</ion-label>\n\n      <ion-input type="text" [(ngModel)]="name" [ngModelOptions]="{standalone: true}"></ion-input>\n\n    </ion-item>\n\n    <!-- Input-field-password -->\n\n    <ion-item no-padding>\n\n      <ion-label stacked>Ghi chú - <i>Không bắt buộc</i></ion-label>\n\n      <ion-input type="text" [(ngModel)]="content" [ngModelOptions]="{standalone: true}"></ion-input>\n\n    </ion-item>\n\n  </div>\n\n\n\n  <br>\n\n  \n\n  <file-pond #myPond2 \n\n    [options]="pondOptions" \n\n    (oninit)="pondHandleInit()"\n\n    (onprocessfile)="pondHandleAddFile()"\n\n    (onremovefile)="pondHandleRemoveFile()">\n\n  </file-pond>\n\n</ion-content>\n\n\n\n'/*ion-inline-end:"D:\Projects\cponpaint\gradutation\cponpaint-app\src\pages\color-mix\color-mix.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4_ionic_angular__["k" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_0__providers_global_global__["a" /* GlobalProvider */]])
    ], ColorMixPage);
    return ColorMixPage;
}());
