...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SuggestProductPageModule", function() { return SuggestProductPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(41);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__suggest_product__ = __webpack_require__(333);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_ngx_filepond__ = __webpack_require__(316);
...
var SuggestProductPageModule = /** @class */ (function () {
    function SuggestProductPageModule() {
    }
    SuggestProductPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__suggest_product__["a" /* SuggestProductPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__suggest_product__["a" /* SuggestProductPage */]),
                __WEBPACK_IMPORTED_MODULE_3_ngx_filepond__["a" /* FilePondModule */]
            ],
        })
    ], SuggestProductPageModule);
    return SuggestProductPageModule;
}());

//# sourceMappingURL=suggest-product.module.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_filepond__ = __webpack_require__(317);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_filepond___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_filepond__);
/* harmony reexport (binding) */ if(__webpack_require__.o(__WEBPACK_IMPORTED_MODULE_1_filepond__, "registerPlugin")) __webpack_require__.d(__webpack_exports__, "b", function() { return __WEBPACK_IMPORTED_MODULE_1_filepond__["registerPlugin"]; });
...
var isSupported = Object(__WEBPACK_IMPORTED_MODULE_1_filepond__["supported"])();
var inputAttributes = [
    'id',
    'name',
    'class',
...
var FilePondComponent = /** @class */ (function () {
    function FilePondComponent(root, zone) {
        ...
        outputs.forEach(function (output) {
            _this[output] = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["EventEmitter"]();
        });
    }
    FilePondComponent.prototype.ngAfterViewInit = function () {
        ...
        this.zone.runOutsideAngular(function () {
            _this.pond = Object(__WEBPACK_IMPORTED_MODULE_1_filepond__["create"])(input, Object.assign({}, _this.options, { files: _this.files }));
        });
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SuggestProductPage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_ngx_filepond__ = __webpack_require__(316);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_filepond_plugin_image_preview_dist_filepond_plugin_image_preview_esm__ = __webpack_require__(318);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_filepond_plugin_image_exif_orientation_dist_filepond_plugin_image_exif_orientation_esm__ = __webpack_require__(319);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_filepond_plugin_file_validate_type_dist_filepond_plugin_file_validate_type_esm__ = __webpack_require__(320);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__providers_global_global__ = __webpack_require__(55);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
Object(__WEBPACK_IMPORTED_MODULE_4_ngx_filepond__["b" /* registerPlugin */])(__WEBPACK_IMPORTED_MODULE_5_filepond_plugin_image_preview_dist_filepond_plugin_image_preview_esm__["a" /* default */], __WEBPACK_IMPORTED_MODULE_6_filepond_plugin_image_exif_orientation_dist_filepond_plugin_image_exif_orientation_esm__["a" /* default */], __WEBPACK_IMPORTED_MODULE_7_filepond_plugin_file_validate_type_dist_filepond_plugin_file_validate_type_esm__["a" /* default */]);
/**
 * Generated class for the SuggestProductPage page.
 *
 * See https://ionicframework.com/docs/components/#navigation for more info on
 * Ionic pages and navigation.
 */
var SuggestProductPage = /** @class */ (function () {
    function SuggestProductPage(navCtrl, loading, rest, alert, global) {
        ...
        this.pondOptions = {
            ...
            allowMultiple: true,
            labelIdle: 'Chọn ảnh',
            labelFileWaitingForSize: 'Đang đợi kích cỡ ảnh',
            labelFileSizeNotAvailable: 'Kích cỡ ảnh không khả dụng',
            labelFileLoading: 'Đang tải',
            labelFileLoadError: 'Lỗi phát sinh khi tải ảnh',
            labelFileProcessing: 'Đang tải lên',
            labelFileProcessingComplete: 'Tải lên thành công',
            labelFileProcessingAborted: 'Đã hủy tải lên',
            labelFileProcessingError: 'Lỗi khi tải ảnh lên',
            labelTapToCancel: 'Hủy',
            labelTapToRetry: 'Thử lại',
            labelTapToUndo: 'Xóa ảnh',
            labelButtonRemoveItem: 'Xóa ảnh',
            labelButtonAbortItemLoad: 'Dừng',
    ...
    SuggestProductPage.prototype.ionViewWillEnter = function () {
        var _this = this;
        var currentTime = new Date();
        this.timestamp = currentTime.getTime();
        this.loading.show();
        this.rest.initSuggestProduct(this.timestamp).then(function (scs) {
            _this.loading.hide();
        }, function (err) {
            _this.loading.hide();
            var initSessionError = _this.alert.create({
                title: 'Lỗi',
            ...
            initSessionError.present();
        });
        var user_token = localStorage.getItem('token');
        this.myPond.pond.setOptions({
            server: {
                process: {
                    url: this.rest.UPLOAD_SUGGEST_PRODUCT_URL + '/process?token=' + user_token + '&&timestamp=' + this.timestamp,
                    method: 'POST',
                    withCredentials: false,
                ...
                revert: {
                    url: this.rest.UPLOAD_SUGGEST_PRODUCT_URL + '/revert?token=' + user_token,
                    method: 'DELETE'
                },
                restore: null,
                load: null,
    ...
    SuggestProductPage.prototype.pondHandleInit = function () {
        console.log('FilePond has initialised', this.myPond);
    };
    SuggestProductPage.prototype.pondHandleAddFile = function () {
        this.pondFiles = this.myPond.getFiles().length;
    };
    SuggestProductPage.prototype.pondHandleRemoveFile = function () {
        this.pondFiles = this.myPond.getFiles().length;
    };
    SuggestProductPage.prototype.clickUpload = function () {
        var _this = this;
        this.loading.show();
        this.rest.postSuggestProductId({ name: this.name, content: this.content }, this.timestamp).then(function (scs) {
            var successUpload = _this.alert.create({
                message: 'Đề xuất đã được gửi lên máy chủ thành công.',
                buttons: [
                    {
                        text: 'OK',
                        handler: function () {
            ...
            _this.name = '';
            _this.content = '';
            successUpload.present();
        }, function (err) {
            var errorUpload = _this.alert.create({
                message: 'Có lỗi đã xảy ra! Xin hãy thử lại sau',
                buttons: [
                    {
                        text: 'OK'
                    }
    ...
    SuggestProductPage.prototype.presentNotifications = function (myEvent) {
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["ViewChild"])('myPond'),
        __metadata("design:type", Object)
    ], SuggestProductPage.prototype, "myPond", void 0);
    SuggestProductPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["Component"])({
            selector: 'page-suggest-product',template:/*ion-inline-start:"D:\Projects\cponpaint\gradutation\cponpaint-app\src\pages\suggest-product\suggest-product.html"*/'<!--\n\n  Generated template for the SuggestProductPage page.\n\n\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n\n  Ionic pages and navigation.\n\n-->\n\n<ion-header>\n\n\n\n  <ion-navbar color="primary">\n\n    <ion-title>Đề xuất công trình</ion-title>\n\n    <ion-buttons end>\n\n      <button ion-button tappable (click)="presentNotifications($event)">\n\n        <div class="badge1" [attr.data-badge]="global.unreadNotificationCount">\n\n            <ion-icon [ngClass]="{\'animated infinite swing delay-2s\':global.unreadNotificationCount > 0}" name="notifications"></ion-icon>\n\n        </div>\n\n      </button>\n\n    </ion-buttons>\n\n  </ion-navbar>\n\n\n\n</ion-header>\n\n\n\n\n\n<ion-content padding>\n\n  <button ion-button block [disabled]="pondFiles === 0 || name === \'\'" (click)="clickUpload()" >Gửi đề xuất</button>\n\n\n\n  <div input-field>\n\n    <!-- Input-field-text -->\n\n    <ion-item no-padding>\n\n      <ion-label stacked>Tên đề xuất</ion-label>\n\n      <ion-input type="text" [(ngModel)]="name" [ngModelOptions]="{standalone: true}"></ion-input>\n\n    </ion-item>\n\n    <!-- Input-field-password -->\n\n    <ion-item no-padding>\n\n      <ion-label stacked>Ghi chú - <i>Không bắt buộc</i></ion-label>\n\n      <ion-input type="text" [(ngModel)]="content" [ngModelOptions]="{standalone: true}"></ion-input>\n\n    </ion-item>\n\n  </div>\n\n\n\n  <br>\n\n\n\n  <file-pond #myPond \n\n    [options]="pondOptions" \n\n    (oninit)="pondHandleInit()"\n\n    (onprocessfile)="pondHandleAddFile()"\n\n    (onremovefile)="pondHandleRemoveFile()">\n\n  </file-pond>\n\n</ion-content>\n\n'/*ion-inline-end:"D:\Projects\cponpaint\gradutation\cponpaint-app\src\pages\suggest-product\suggest-product.html"*/,
        }),
    ...
    return SuggestProductPage;
}());

//# sourceMappingURL=suggest-product.js.map
